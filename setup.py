...
def setup_env_file():
    ...
    try:
        ...
        print("💡 Please edit .env and update GEMINI_API_KEY with your actual key")
        return True
...
def validate_setup():
    ...
    try:
        ...
        print("💡 This is expected if you haven't set GEMINI_API_KEY yet")
        return True
...
def main():
    ...
    if not create_logs_directory():
        print("\n❌ Setup failed during logs directory creation")
        sys.exit(1)
